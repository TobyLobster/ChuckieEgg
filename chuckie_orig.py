...
label(0x0001, "intervaltimerblock + 1")
label(0x001B, "savesp")
...
label(0x003A, "bonus")
label(0x003B, "bonus + 1")
label(0x003C, "bonus + 2")
...
label(0x0509, "playerbonus + 1")
label(0x050A, "playerbonus + 2")
...
label(0x2B78, "string_vdu19_start + 1")
label(0x2b79, "string_vdu19_start + 2")
