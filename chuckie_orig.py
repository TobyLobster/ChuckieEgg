...
mylabel(0x1208, "sprite_ladder")
mylabel(0x1210, "sprite_egg")
mylabel(0x1218, "sprite_seed")
mylabel(0x1220, "sprite_lift")
mylabel(0x1228, "sprite_manright1")
mylabel(0x1238, "sprite_manright2")
mylabel(0x1248, "sprite_manright3")
mylabel(0x1258, "sprite_manleft1")
mylabel(0x1268, "sprite_manleft2")
mylabel(0x1278, "sprite_manleft3")
mylabel(0x1288, "sprite_manupdown1")
mylabel(0x1298, "sprite_manupdown2")
mylabel(0x12AA, "sprite_manupdown3")
mylabel(0x12BC, "sprite_bigbirdright1")
mylabel(0x12EC, "sprite_bigbirdright2")
mylabel(0x131C, "sprite_bigbirdleft1")
mylabel(0x134C, "sprite_bigbirdleft2")
mylabel(0x137C, "sprite_cagewithhole")
mylabel(0x140C, "sprite_cage")
mylabel(0x149C, "sprite_birdright1")
mylabel(0x14B0, "sprite_birdright2")
mylabel(0x14C4, "sprite_birdleft1")
mylabel(0x14D8, "sprite_birdleft2")
mylabel(0x14EC, "sprite_birdupdown1")
mylabel(0x1500, "sprite_birdupdown2")
mylabel(0x1516, "sprite_birdeatright1")
mylabel(0x153E, "sprite_birdeatright2")
mylabel(0x1566, "sprite_birdeatleft1")
mylabel(0x158E, "sprite_birdeatleft2")
mylabel(0x15B6, "sprite_digit0")
mylabel(0x15BD, "sprite_digit1")
mylabel(0x15C4, "sprite_digit2")
mylabel(0x15CB, "sprite_digit3")
mylabel(0x15D2, "sprite_digit4")
mylabel(0x15D9, "sprite_digit5")
mylabel(0x15E0, "sprite_digit6")
mylabel(0x15E7, "sprite_digit7")
mylabel(0x15EE, "sprite_digit8")
mylabel(0x15F5, "sprite_digit9")
mylabel(0x15FC, "sprite_score")
mylabel(0x1617, "sprite_highlightbox")
mylabel(0x163B, "sprite_player")
mylabel(0x165F, "sprite_level")
mylabel(0x168C, "sprite_bonus")
mylabel(0x16C2, "sprite_time")
mylabel(0x16EF, "sprite_life")
mylabel(0x16F2, "sprite_bigc")
mylabel(0x172E, "sprite_bigh")
mylabel(0x176A, "sprite_bigu")
mylabel(0x17A6, "sprite_bigk")
mylabel(0x17E2, "sprite_bigi")
